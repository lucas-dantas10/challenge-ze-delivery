 ...
 */
final class Version20240520012511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN users.s_user.pt_address IS \'(DC2Type:pointGeometry)\'');
